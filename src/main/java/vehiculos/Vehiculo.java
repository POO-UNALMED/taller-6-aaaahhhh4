...
public class Vehiculo {
	...
	public Vehiculo(String placa, int puertas, int velocidadMaxima, String nombre, int precio, int peso,
		...
		cantidadVehiculos++;
		int a=Fabricante.fabricantes.get(fabricante);
		Fabricante.fabricantes.replace(fabricante,a+1);
		int b=Pais.paises.get(fabricante.getPais());
		Pais.paises.replace(fabricante.getPais(),b+1);
	}
